(function($) {
    ...
    if($(".team-slider".length)) {
        $(".team-slider").owlCarousel({
            ...
            autoplayHoverPause:true,
            nav: true,
            navText: ['<i class="fa fa-arrow-right">','<i class="fa fa-arrow-left">'],
            responsive: {
                0 : {
                    items: 1
                },
    ...
    if ($(".shop-single-slider-wrapper").length) {
        ...
        $('.slider-nav').slick({
            ...
            asNavFor: '.slider-for',
            focusOnSelect: true,
            prevArrow: '<i class="nav-btn nav-btn-lt fa fa-long-arrow-right"></i>',
            nextArrow: '<i class="nav-btn nav-btn-rt fa fa-long-arrow-left"></i>',
    ...
    if ($("#contact-form").length) {
        $("#contact-form").validate({
            ...
            messages: {
                ...
                phone: "لطفا شماره تلفن خود را وارد کنید",
                select: "موردی را انتخاب کنید"
            },
